...
> land milestone by milestone - four of the five read tools are live
> (`crm_metadata`, `search_crm`, `get_records`, `get_activity`, next to
> `health`); `analyze` and the five write tools are planned. Until the write
